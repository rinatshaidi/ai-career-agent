...
- `validate-migrations.ps1` validates SQL migration presence, runs every verification SQL contract, and can optionally apply migrations against a disposable PostgreSQL container.
