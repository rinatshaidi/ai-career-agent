...
$requiredFiles = @(
    ...
    'database\sql\verify_block6_feedback_learning.sql',
    'database\sql\verify_block65_production_integration.sql',
    'docs\ai-decision-engine.md',
    'docs\feedback-learning-engine.md',
    'docs\opportunity-collection.md',
    'docs\telegram-delivery-engine.md',
    'docs\adr\0004-feedback-learning-working-memory-split.md',
    ...
    'docs\runbooks\import-feedback-learning-workflows.md',
    'docs\runbooks\configure-google-sheets-feedback-archive.md',
    'n8n\README.md',
    ...
    'scripts\validate-feedback-learning-workflow.ps1',
    'tests\README.md'
)
